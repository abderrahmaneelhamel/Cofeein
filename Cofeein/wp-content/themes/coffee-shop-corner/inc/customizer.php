...
function coffee_shop_corner_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('coffee_shop_corner_theme_options',array(
		'default' => 'One Column',
		'sanitize_callback' => 'coffee_shop_corner_sanitize_choices'
	));
	$wp_customize->add_control('coffee_shop_corner_theme_options',array(
		'type' => 'select',
		'label' => __('Blog Page Sidebar Layout','coffee-shop-corner'),
